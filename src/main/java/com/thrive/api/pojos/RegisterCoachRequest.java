...
//	@Expose
	...
	public RegisterCoachRequest(String firstName, String lastName, String password, String careerSmeRoles, String about,
			Integer careerCorporateTime, String city, String coachHoursInYear,
			List<String> coachedPeople, String coachingSummary, String companyName, String comapnyType,
			String companyWebsite, Integer corporateWeekTime, String country, String email, Boolean emailUpdates,
			String employmentStatus, String gender, List<Integer> industries, List<String> languages, Double latitude,
			Double longitude, String mobileNumber, String nationality, String otherSeniorPositions, String photo,
			String postcode, String professionalSummary, String region, String selectedLocale, String testimonial,
			List<Qualification> qualifications, List<Expertise> expertise, List<EnableCategory> enableCategories,
			String address1, Boolean issmsremindersenabled, List<UserDetails> userdetails, int careersmetime,
			String companyindemnitycover, String companyindemnityprovider, String companyregnumber,
			String companyvatregnumber) {
		super();
		...
		//sthis.careerIndustries = careerIndustries;
		this.city = city;
	...
	public RegisterCoachRequest(String firstName, String lastName, String password, Integer careerCorporateTime,
			String city, String coachingSummary, Integer corporateWeekTime, String country, String email,
			...
			List<UserDetails> userdetails, int careersmetime,int yearsAsCoach) {
		super();
		this.firstName = firstName;
		this.lastName = lastName;
		this.password = password;
