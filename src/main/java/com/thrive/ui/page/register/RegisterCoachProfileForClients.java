...
public class RegisterCoachProfileForClients extends UserManagementCommonPage {
	...
	private By getTopOrganisationCoachedInErrorMsg() {
		return By.xpath(getXpathByText("//label[contains(text(),'questions.registeration_coach.fxlv1ij4p4a.label')]/../following-sibling::div/p[contains(text(),'shared.support_form.required_field')]"));
	}
	
	private By getRegionErrorMsg() {
		return By.xpath(getXpathByText("//label[contains(text(),'questions.registeration_coach.5wnjeo3sqf.label')]/../following-sibling::div/p[contains(text(),'shared.support_form.required_field')]"));
	}
	
	private By getCoachingQualificationErrorMsg() {
		return By.xpath(getXpathByText("//label[contains(text(),'questions.registeration_coach.z07jhxig2o.label')]//following-sibling::span//p[contains(text(),'shared.support_form.required_field')]"));
	}
	
	private By getLanguageErrorMsg() {
		return By.xpath(getXpathByText("//label[contains(text(),'register.coach.step3.languages')]/../following-sibling::div/p[contains(text(),'shared.support_form.required_field')]"));
	}

	private By getDateAwardedErrorMsg() {
		return By.xpath(getXpathByText("//label[contains(text(),'register.coach.step3.awarded_at')]//following-sibling::div//p[contains(text(),'shared.support_form.required_field')]"));
	}
	
	private By getCoachExperiencelTextArea() {
		return By.xpath(getXpathByText(
				".//label[contains(text(),'questions.registeration_coach.0b3natx2msdd.label')]/../following-sibling::input"));
	}

	private By getTopNewIndustriesTextArea() {
		return By.xpath(getXpathByText(
				".//label[contains(text(),'questions.registeration_coach.fxlv1ij4p4a.label')]/../following-sibling::textarea"));
	}
	...
	private By getTestimonialErrorMsg() {
		return By.xpath(getXpathByText(
				".//label[contains(text(),'register.coach.step6.testimonial')]/../following-sibling::div/p[contains(text(),'"+ errorMsg + "')]"));
	}

	private By getAboutTextAreaErrorMsg() {
		return By.xpath(getXpathByText(
				".//label[contains(text(),'register.coach.register.personal.step_6_name')]/../following-sibling::div/p[contains(text(),'"+ errorMsg + "')]"));
	}

	private By getProfessionalSummaryErrorMsg() {
		return By.xpath(getXpathByText(
				".//label[contains(text(),'questions.registeration_coach.professional_summary.label')]/../following-sibling::div/p[contains(text(),'shared.support_form.required_field')]"));
	}

	private By getTopNewIndustriesErrorMsg() {
		return By.xpath(getXpathByText(".//label[contains(text(),'register.coach.step5.industries')]/../following-sibling::div/p[contains(text(),'shared.support_form.required_field')]"));
	}

	private By getCoachingSummaryErrorMsg() {
		if (Config.getLocalizationLanguage().contains("en")) {
			return By.xpath(getXpathByText(
					".//label[contains(text(),'questions.registeration_coach.coaching_summary.label')]/../following-sibling::div/p[contains(text(),'shared.support_form.required_field')]"));
		} else {
			return By.xpath(".//label[contains(text(),'En quelques mots')]/../following-sibling::div/p[contains(text(),'"+ errorMsg + "')]");
		}
	}

	private By getPrivacyPolicyErrorMsg() {
		if (Config.getLocalizationLanguage().contains("en")) {
			return By.xpath(getXpathByText(
					".//label[contains(text(),'register.coach.step6.privacy_notice')]/..//p[contains(text(),'ui.messages.privacy_notice.required_field')]"));
		} else {
			return By.xpath(
	...
	private By getHeadLineSummaryErrorMsg() {
		if (Config.getLocalizationLanguage().contains("en")) {
			return By.xpath(getXpathByText(
					".//label[contains(text(),'questions.registeration_coach.summary.label')]/../following-sibling::div/p[contains(text(),'shared.support_form.required_field')]"));
		} else {
			return By.xpath(".//label[contains(text(),'Présentation Synthètique')]/../following-sibling::div/p[contains(text(),'"+ errorMsg + "')]");
		}
	}
	...
	private By getYearsAsCoachErrorMsg() {
		if (Config.getLocalizationLanguage().contains("en")) {
			return By.xpath(getXpathByText(
					".//label[contains(text(),'questions.registeration_coach.0588mrmyvul.label')]/../following-sibling::div/p[contains(text(),'"+ errorMsg + "')]"));
		} else {
			return By.xpath(".//label[contains(text(),'années en tant que Coach')]/../following-sibling::div/p[contains(text(),'"+ errorMsg + "')]");
		}
	}

	public RegisterCoachProfileForClients registerCoach(CoachAboutDetails coachAboutDetails) {
	...
	public RegisterCoachProfileForClients setSummaryInput(String summary) {
	...
	public RegisterCoachProfileForClients setSummaryInputRm(String summary) {
		LOGGER.info("Setting value for summary input");
		setValue(summary, getSummryTextAreaRm());
		return this;
	}

	public RegisterCoachProfileForClients setTopNewIndustries(String industry) {
		LOGGER.info("Setting value for top new industry");
		setValueWithoutValidation(industry, getTopNewIndustriesTextArea());
		return this;
	}

	public RegisterCoachProfileForClients setAboutInput(String about) {
	...
	public RegisterCoachProfileForClients selectFirstAvailabelCoachOffers(String coachOffer) {
	...
	public RegisterCoachProfileForClients setCoachExperience(String experience) {
		LOGGER.info("Setting value for coach experience");
		setValue(experience, getCoachExperiencelTextArea());
		return this;
	}

	public RegisterCoachProfileForClients setProfessionalSummary(String profSummary) {
		LOGGER.info("Setting value for professional summary");
		setValue(profSummary, getProfessionalSummaryTextArea());
		return this;
	}

	public RegisterCoachProfileForClients setTestinomial(String testinamial) {
		LOGGER.info("Setting value for testimonials");
		setValue(testinamial, getTestimonialTextArea());
		return this;
	}

	public RegisterCoachProfileForClients setCoachingSummary(String coachingSummary) {
	...
	private By getYearsAsCoachRm() {
		return By.xpath(getXpathByText(".//label[contains(text(),'private.coach.years')]/..//following-sibling::div//p[contains(text(),'shared.support_form.required_field')]"));
	}
	
	private By getYearsAsCoach() {
		return By.xpath(getXpathByText(".//label[contains(text(),'private.coach.years')]/..//following-sibling::input"));
	}

	public RegisterCoachProfileForClients setYearsAsCoachRm(String yearsascoach) {
		LOGGER.info("Setting value for years as coach");
		setValue(yearsascoach, getYearsAsCoach());
		return this;
	}
	...
	public RegisterCoachProfileForClients clickregisterButton() {
	...
	public RegisterCoachProfileForClients selectDateAwarded(int date) {
	...
	public RegisterCoachProfileForClients selectRegion(String region) {
	...
	public RegisterCoachProfileForClients selectIndustry(String industry) {
	...
	public RegisterCoachProfileForClients selectLanguages(List<String> languages) {
	...
	public RegisterCoachProfileForClients validateLanguagePresent(String val) {
	...
	public RegisterCoachProfileForClients validateIndustryPresent(String val) {
		LOGGER.info("Validate selected language present");
		Assert.assertTrue(isElementPresent(getIndustryName(val)));
		return this;
	}

	public RegisterCoachProfileForClients submitCoachAboutInfo(CoachAboutDetails coachAboutDetails, String yearsascoach) {
		...
		if (Config.getTestPlatform().equalsIgnoreCase(TestPlatform.THRIVE)) {
			...
			setValue(coachAboutDetails.getYearsAsCoach(), getYearsAsCoach());
	...
	public RegisterCoachProfileForClients submitCoachAboutInfoRm(CoachAboutDetails coachAboutDetails, String yearsascoach) {
		LOGGER.info("Submitting coach about information");
		try {
			setValue(coachAboutDetails.getSummry(), getSummryTextAreaRm());
	...
	public RegisterCoachProfileForClients validateAboutPageErrorValidation() {
		...
		if (Config.getTestPlatform().equalsIgnoreCase(TestPlatform.THRIVE)) {
			...
			softAssert.assertTrue(isElementPresent(getPrivacyPolicyErrorMsg()),
		...
		//	softAssert.assertTrue(isElementPresent(getTestimonialErrorMsg()),"error message not present for testinomial");
		    softAssert.assertTrue(isElementPresent(getYearsAsCoachRm()),"error message not present for Years As Coach");
		    softAssert.assertTrue(isElementPresent(getRegionErrorMsg()),"error message not present for Region");
		    softAssert.assertTrue(isElementPresent(getLanguageErrorMsg()),"error message not present for Languages");
		    softAssert.assertTrue(isElementPresent(getHeadLineSummaryErrorMsg()),"error message not present for Headline Summary");
		    softAssert.assertTrue(isElementPresent(getTopOrganisationCoachedInErrorMsg()),"error message not present for Top Organisations Coached In");
		    softAssert.assertTrue(isElementPresent(getCoachingSummaryErrorMsg()),"error message not present for Coaching Summary");
		    softAssert.assertTrue(isElementPresent(getDateAwardedErrorMsg()),"error message not present for Date Awarded");
		    softAssert.assertTrue(isElementPresent(getCoachingQualificationErrorMsg()),"error message not present for coaching qualification");
		} else if (Config.getTestPlatform().equalsIgnoreCase(TestPlatform.RM)) {

			softAssert.assertTrue(
					isElementPresent(
							getPrivacyPolicyErrorMsg()),
					"error message not present for privacy policy");
	...
	public RegisterCoachProfileForClients validateCoachAboutInfo(CoachAboutDetails coachAboutDetails) {
