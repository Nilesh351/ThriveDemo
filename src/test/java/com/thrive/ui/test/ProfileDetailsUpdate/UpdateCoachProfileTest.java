...
public class UpdateCoachProfileTest extends UserManagementCommonPage{
	...
	@Test(description="Validate SA successfully update coach profile details")
	public void updateCaochProfileDetails() {
		
		getExtentTestLogger().assignCategory(TestCategory.USER_PROFILE_UPDATE.getValue());
		
		getExtentTestLogger().log(Status.PASS, "Update coach Personal details");
		validateCoachPersonalDetailsUpdate();
		
		getExtentTestLogger().log(Status.PASS, "Update coach Mentoring experience details");
		validateCoachMentoringExperience();
		
		getExtentTestLogger().log(Status.PASS, "Update coach about deatils");
		validateCoachAbout();
		
//		if(Config.getTestPlatform().equalsIgnoreCase("thrive")) {
//			
//			getExtentTestLogger().log(Status.PASS, "Update coach Employmemt details");
//			validateCoachEmploymentUpdate();
//			
//			getExtentTestLogger().log(Status.PASS, "Update coach Skills and Qualification details");
//			validateCoachSkillsAndQualificatiosUpdate();
//			
//			getExtentTestLogger().log(Status.PASS, "Update coach Corporate expertise details");
//			validateCoachCorporateExpertise();
//		}
//		else {
//			getExtentTestLogger().log(Status.PASS, "Update coach languages details");
//			validateCoachLanguagesUpdate();
//		}
	...
	private UpdateCoachProfileTest validateCoachPersonalDetailsUpdate() {
		...
		getExtentTestLogger().log(Status.PASS, "User navigates to the user management -> coaches");
		...
		globalCoachesPage.setSearch(globalCoachUserUpdate);
		registerCoachPersonalDetailsPage = globalCoachesPage.clickOnSearchedCoachName(globalCoachUserUpdate);
...
//		registerCoachPersonalDetailsPage.selectFirstAvailabelRegion();
	...
	private UpdateCoachProfileTest validateCoachEmploymentUpdate() {
	...
	private UpdateCoachProfileTest validateCoachSkillsAndQualificatiosUpdate() {
	...
	private UpdateCoachProfileTest validateCoachLanguagesUpdate() {
	...
	private UpdateCoachProfileTest validateCoachCorporateExpertise() {
	...
	private UpdateCoachProfileTest validateCoachMentoringExperience() {
		...
		registerCoachMentoringExpPage.selectAvailableExpertiseOption();
...
//		}
		...
		registerCoachMentoringExpPage.validateMentoringExperience();
		
		return this;
		
	}
	
	private UpdateCoachProfileTest validateCoachAbout() {
...
//			registerCoachAboutPage.setCoachExperience(coachAboutDetails.getCoachExperience());
