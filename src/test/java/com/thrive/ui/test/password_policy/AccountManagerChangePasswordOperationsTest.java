...
public class AccountManagerChangePasswordOperationsTest extends UserManagementCommonPage {
	...
	public void validateChangePasswordCannotEmpty() {
		...
		getExtentTestLogger().log(Status.PASS,
				"Validate Account Manager cannot provide empty fields and gets error message");
	...
	public void validateChangePasswordCannotEmailAddress() {
		...
		changePasswordPage.setExistingPassword(accountManagerUser);
		changePasswordPage.setNewPassword(accountManagerUser);
		changePasswordPage.setConfirmPassword(accountManagerUser);
	...
	public void validateChangePasswordCannotbeOldPassword() {
		...
		getExtentTestLogger().log(Status.PASS, "Provide all password details");
		changePasswordPage.setExistingPassword(accountManagerPassword);
		changePasswordPage.setNewPassword(accountManagerPassword);
		changePasswordPage.setConfirmPassword(accountManagerPassword);
