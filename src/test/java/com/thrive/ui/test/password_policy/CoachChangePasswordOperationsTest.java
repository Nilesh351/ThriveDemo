...
public class CoachChangePasswordOperationsTest extends UserManagementCommonPage {
	...
	public void validateChangePasswordCannotEmpty() {
		...
		getExtentTestLogger().log(Status.PASS, "Validate Coach cannot provide empty fields and gets error message");
	...
	public void validateChangePasswordCannotEmailAddress() {
		...
		changePasswordPage.setExistingPassword(globalCoachUser);
		changePasswordPage.setNewPassword(globalCoachUser);
		changePasswordPage.setConfirmPassword(globalCoachUser);
	...
	public void validateChangePasswordCannotbeOldPassword() {
		...
		getExtentTestLogger().log(Status.PASS, "Provide all password details");
		changePasswordPage.setExistingPassword(globalCoachPassword);
		changePasswordPage.setNewPassword(globalCoachPassword);
		changePasswordPage.setConfirmPassword(globalCoachPassword);
